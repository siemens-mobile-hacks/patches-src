//  Draw Hook //
//alpha_selector.asm - Отлов полупрозрачной картинки
//(c)Dimadze
...
// Вычисление аргументов для нашей ф-ии отрисовки 
       ...
       img_05_check: // Проверка на присутствии полупрозрачого IMGHDR
...
#ifdef X75
                    BLX    isCSMException  // Посмотрим, а CSM которая "на верху" не исключение?
                    CMP    R0, #0x01
                    MOV    R0, R5 
                    ...
                    MOV    R1, #0xF0       // Подготовка к очистке бит
                    BIC    R2, R1          // Очищаем 4-8 биты, т.е. любое число 0xXA будет как 0x0A
    ...
    is_csm_exc_05:
       ...
       img_17_check: // Проверка на присутствии полупрозрачого EIMGHDR
   
                    SUB    SP, #0x14       // Востановление комманды
